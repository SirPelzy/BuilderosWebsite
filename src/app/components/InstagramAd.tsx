...
export function InstagramAd() {
  return (
    ...
    >
      ...
      {/* ── Main content — absolutely positioned inside the square ── */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      >
        ...
        >
          <LogoMark size={30} color="#FFFFFF" accentColor="#34D399" />
          <Wordmark
            height={16}
            color="#FFFFFF"
        ...
        >
          <div
            style={{
              ...
              boxShadow:
                "0 4px 24px rgba(16,185,129,0.3), 0 0 60px rgba(16,185,129,0.08)",
              cursor: "pointer",
            }}
          >
            <span
