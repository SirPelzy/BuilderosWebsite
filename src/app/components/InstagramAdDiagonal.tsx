...
export function InstagramAdDiagonal() {
  return (
    <div
      style={{
        position: "relative",
    ...
    >
      {/* ── Bottom diagonal panel (emerald-tinted dark) ── */}
      <div
        style={{
          position: "absolute",
          bottom: 0,
          ...
          height: "48%",
          background:
            "linear-gradient(175deg, #0D1B2A 0%, #0F1D2F 60%, #101F32 100%)",
      ...
      >
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          >
            ...
            Diaspora Nigerians
            <br />
            <span style={{ color: "#34D399" }}>Building Back Home.</span>
          </h1>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "clamp(6px, 1.5vw, 10px)" }}>
            ...
            <div
              style={{
                ...
                boxShadow: "0 4px 24px rgba(16,185,129,0.25), 0 0 0 1px rgba(16,185,129,0.3)",
              }}
            >
              Book a 15-Min Chat
              <ArrowRight
