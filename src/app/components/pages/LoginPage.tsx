...
export function LoginPage() {
  ...
  return (
    <div
      ...
      style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "var(--bos-bg-3)", color: "var(--bos-text-1)" }}
    >
      {/* Left panel */}
      <div
      ...
      >
        ...
        />
        <div
          className="absolute w-[400px] h-[400px] -bottom-[100px] -right-[100px] rounded-full"
          style={{
            background:
        ...
        <div className="relative z-10">
          ...
          >
            ...
            >
              Welcome Back to
              <br />
              <span style={{ color: "#34D399" }}>BuilderOS</span>
            </h1>
            <p
            ...
            >
              Continue managing your construction projects with confidence.
            </p>
        ...
        >
          Trusted by diaspora Nigerians building across Lagos, Abuja, and Port
          Harcourt.
        </p>
      </div>
          ...
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-[48px] rounded-xl px-4 border-none outline-none text-[15px]"
                style={{
                  fontFamily: "'Inter', sans-serif",
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  type="button"
                  className="text-[12px] text-emerald-400 cursor-pointer border-none bg-transparent"
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full h-[48px] rounded-xl px-4 pr-12 border-none outline-none text-[15px]"
                  style={{
                    fontFamily: "'Inter', sans-serif",
                    background: "var(--bos-input-bg)",
                    border: "1px solid var(--bos-input-border)",
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="remember" className="text-[13px] cursor-pointer" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400, color: "var(--bos-text-3)" }}>
                Remember me
              </label>
            </div>
